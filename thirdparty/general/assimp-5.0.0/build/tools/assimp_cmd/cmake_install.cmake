# Install script for directory: /Users/xarvie/Desktop/3d/thirdparty/general/assimp-5.0.0/tools/assimp_cmd
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xassimp-binx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE FILES "/Users/xarvie/Desktop/3d/thirdparty/general/assimp-5.0.0/build/tools/assimp_cmd/assimp")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/assimp" AND
    ...
    execute_process(COMMAND /usr/bin/install_name_tool
      -delete_rpath "/Users/xarvie/Desktop/3d/thirdparty/general/assimp-5.0.0/build"
      "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/assimp")
    execute_process(COMMAND /usr/bin/install_name_tool
      -delete_rpath "/Users/xarvie/Desktop/3d/thirdparty/general/assimp-5.0.0/build/lib"
      "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/assimp")
    execute_process(COMMAND /usr/bin/install_name_tool
      -delete_rpath "/Users/xarvie/Desktop/3d/thirdparty/general/assimp-5.0.0/build/code"
      "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/assimp")
    execute_process(COMMAND /usr/bin/install_name_tool
