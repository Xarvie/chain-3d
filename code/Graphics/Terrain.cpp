...
//    }
    ...
    shaderDrawSceneT = new Shader(SHADER_DIR"TerrainVoxel.vert.glsl", SHADER_DIR"TerrainVoxel.frag.glsl");
    shaderDrawSceneDepth = new Shader(SHADER_DIR"ShadowMappingDepthStatic.vert.glsl", SHADER_DIR"ShadowMappingDepthStatic.frag.glsl");
