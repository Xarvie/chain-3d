...
void SkeletalMesh::initMeshMaterial(const aiMaterial *pMaterial, std::vector<TextureEx1> &mesh_textures) {
...
TextureEx1 SkeletalMesh::loadMaterialFile(const aiMaterial *pMaterial, aiTextureType aiType, TextureEnum texEnum) {
    aiString Path;
    ...
    TextureEx1 tex(GL_TEXTURE_2D, FullPath, texEnum);
